...
urlpatterns = [
    ...
    path('agregar_contenido_aficionado/', agregar_contenido_aficionado, name='agregar_contenido_aficionado'),
    path('eliminarContenido/<int:id_contenido>/', eliminar_contenido, name='eliminar_contenido'),
